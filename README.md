###The original data and experimental set-up description
...
###The original data collection and processing
...
The script run_analysis.R performs flowing data manipulations:
...
###Variables in transformed data set
